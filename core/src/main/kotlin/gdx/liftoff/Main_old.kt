...
class Main : ApplicationAdapter() {
	...
	private var joystickX = 180f
private var joystickY = 180f
...
private var touchingJoystick = false
    ...
    val dx = touchX - joystickX
    val dy = touchY - joystickY
	...
	playerX += moveX * 400f * Gdx.graphics.deltaTime
playerY += moveY * 400f * Gdx.graphics.deltaTime
...
shape.circle(
    joystickX + moveX * joystickRadius,
    joystickY + moveY * joystickRadius,
    knobRadius
)
